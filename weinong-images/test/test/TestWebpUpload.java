...
import com.weinong.base.BaseConf;
...
//        String url = "http://123.56.98.160:8680/upload_webp_images_j.wn";//正式服务器//
...
//        String watermark =" text=wn518.com&coordinate=0,0&size=12";
        String watermark =" text=wn518.com&size=12";
    ...
    public static void setThumbnail(List<Header> headerList)
    {
        ...
        String thumbnail3 = "type=scale&size=140*140&quality=50 ";
